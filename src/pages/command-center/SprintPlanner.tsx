  ...
  return (
    <div className="p-8 space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="font-inter text-white/40 text-sm">{roadmap.totalSprints} sprints · {roadmap.sprintDuration} weeks each · {roadmap.totalSprints * roadmap.sprintDuration} weeks total</p>
      </motion.div>
